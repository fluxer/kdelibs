...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_EQ = 3,                         /* EQ  */
  YYSYMBOL_MASK = 4,                       /* MASK  */
  YYSYMBOL_AND = 5,                        /* AND  */
  YYSYMBOL_OR = 6,                         /* OR  */
  YYSYMBOL_IS = 7,                         /* IS  */
  YYSYMBOL_VAL_BOOL = 8,                   /* VAL_BOOL  */
  YYSYMBOL_VAL_STRING = 9,                 /* VAL_STRING  */
  YYSYMBOL_VAL_ID = 10,                    /* VAL_ID  */
  YYSYMBOL_VAL_NUM = 11,                   /* VAL_NUM  */
  YYSYMBOL_VAL_FLOAT = 12,                 /* VAL_FLOAT  */
  YYSYMBOL_13_ = 13,                       /* '['  */
  YYSYMBOL_14_ = 14,                       /* ']'  */
  YYSYMBOL_15_ = 15,                       /* '.'  */
  YYSYMBOL_16_ = 16,                       /* '{'  */
  ...
  YYSYMBOL_predicate = 20,                 /* predicate  */
  YYSYMBOL_predicate_atom = 21,            /* predicate_atom  */
  YYSYMBOL_predicate_or = 22,              /* predicate_or  */
  YYSYMBOL_predicate_and = 23,             /* predicate_and  */
  YYSYMBOL_value = 24,                     /* value  */
  YYSYMBOL_string_list = 25,               /* string_list  */
  YYSYMBOL_string_list_rec = 26            /* string_list_rec  */
};
...
{
  "\"end of file\"", "error", "\"invalid token\"", "EQ", "MASK", "AND",
  "OR", "IS", "VAL_BOOL", "VAL_STRING", "VAL_ID", "VAL_NUM", "VAL_FLOAT",
  "'['", "']'", "'.'", "'{'", "'}'", "','", "$accept", "predicate",
  "predicate_atom", "predicate_or", "predicate_and", "value",
  "string_list", "string_list_rec", YY_NULLPTR
};

...
set(SBIN_INSTALL_DIR     "${EXEC_INSTALL_PREFIX}/sbin" CACHE PATH "")
set(LIB_INSTALL_DIR      "${EXEC_INSTALL_PREFIX}/lib${LIB_SUFFIX}" CACHE PATH "")
set(LIBEXEC_INSTALL_DIR  "${LIB_INSTALL_DIR}/kde4/libexec" CACHE PATH "")
set(INCLUDE_INSTALL_DIR  "${CMAKE_INSTALL_PREFIX}/include" CACHE PATH "")

set(PLUGIN_INSTALL_DIR       "${LIB_INSTALL_DIR}/kde4" CACHE PATH "")
set(IMPORTS_INSTALL_DIR      "${PLUGIN_INSTALL_DIR}/imports" CACHE PATH "")
set(CONFIG_INSTALL_DIR       "${SHARE_INSTALL_PREFIX}/config" CACHE PATH "")
set(DATA_INSTALL_DIR         "${SHARE_INSTALL_PREFIX}/apps" CACHE PATH "")
set(ICON_INSTALL_DIR         "${SHARE_INSTALL_PREFIX}/icons" CACHE PATH "")
set(KCFG_INSTALL_DIR         "${SHARE_INSTALL_PREFIX}/config.kcfg" CACHE PATH "")
set(LOCALE_INSTALL_DIR       "${SHARE_INSTALL_PREFIX}/locale" CACHE PATH "")
set(MIME_INSTALL_DIR         "${SHARE_INSTALL_PREFIX}/mimelnk" CACHE PATH "")
set(SERVICES_INSTALL_DIR     "${SHARE_INSTALL_PREFIX}/kde4/services" CACHE PATH "")
set(SERVICETYPES_INSTALL_DIR "${SHARE_INSTALL_PREFIX}/kde4/servicetypes" CACHE PATH "")
...
set(XDG_DIRECTORY_INSTALL_DIR "${SHARE_INSTALL_PREFIX}/desktop-directories" CACHE PATH "")
set(XDG_MIME_INSTALL_DIR     "${SHARE_INSTALL_PREFIX}/mime/packages" CACHE PATH "")

set(SYSCONF_INSTALL_DIR      "${CMAKE_INSTALL_PREFIX}/etc" CACHE PATH "")
set(MAN_INSTALL_DIR          "${SHARE_INSTALL_PREFIX}/man" CACHE PATH "")
set(INFO_INSTALL_DIR         "${SHARE_INSTALL_PREFIX}/info" CACHE PATH "")
set(DBUS_INTERFACES_INSTALL_DIR "${SHARE_INSTALL_PREFIX}/dbus-1/interfaces" CACHE PATH "")
set(DBUS_SERVICES_INSTALL_DIR "${SHARE_INSTALL_PREFIX}/dbus-1/services" CACHE PATH "")
set(DBUS_SYSTEM_SERVICES_INSTALL_DIR "${SHARE_INSTALL_PREFIX}/dbus-1/system-services" CACHE PATH "")

set(KAUTH_HELPER_PLUGIN_DIR  "${PLUGIN_INSTALL_DIR}/plugins/kauth/helper" CACHE PATH "")
set(KAUTH_BACKEND_PLUGIN_DIR "${PLUGIN_INSTALL_DIR}/plugins/kauth/backend" CACHE PATH "")

...
void KDirModelTest::testItemForIndex()
{
    ...
    QCOMPARE(fileItem.url().toLocalFile(), QString(m_tempDir->name() + "toplevelfile_1"));
    ...
    QCOMPARE(dirItem.url().toLocalFile(), QString(m_tempDir->name() + "subdir"));
    ...
    QCOMPARE(fileInDirItem.url().toLocalFile(), QString(m_tempDir->name() + "subdir/testfile"));
    ...
    QCOMPARE(fileInSubdirItem.url().toLocalFile(), QString(m_tempDir->name() + "subdir/subsubdir/testfile"));
}
...
void KDirModelTest::testDeleteDirectory()
{
    ...
    QCOMPARE(spyDirWatchDeleted.count(), 3);
}

...
namespace KIO
{
  ...
  enum Error {
    ...
    ERR_UNSUPPORTED_ACTION = KJob::UserDefinedError + 7,
    // ... where a file was expected
    ERR_IS_DIRECTORY = KJob::UserDefinedError + 8,
    // ... where a directory was expected (e.g. listing)
    ERR_IS_FILE = KJob::UserDefinedError + 9,
    ERR_DOES_NOT_EXIST = KJob::UserDefinedError + 10,
    ERR_FILE_ALREADY_EXIST = KJob::UserDefinedError + 11,
    ERR_DIR_ALREADY_EXIST = KJob::UserDefinedError + 12,
    ERR_UNKNOWN_HOST = KJob::UserDefinedError + 13,
    ERR_ACCESS_DENIED = KJob::UserDefinedError + 14,
    ERR_WRITE_ACCESS_DENIED = KJob::UserDefinedError + 15,
    ERR_CANNOT_ENTER_DIRECTORY = KJob::UserDefinedError + 16,
    ERR_CYCLIC_LINK = KJob::UserDefinedError + 17,
    ERR_USER_CANCELED = KJob::KilledJobError,
    ERR_COULD_NOT_CONNECT = KJob::UserDefinedError + 18,
    ERR_CONNECTION_BROKEN = KJob::UserDefinedError + 19,
    ERR_COULD_NOT_MOUNT = KJob::UserDefinedError + 20,
    ERR_COULD_NOT_UNMOUNT = KJob::UserDefinedError + 21,
    ERR_COULD_NOT_READ = KJob::UserDefinedError + 22,
    ERR_COULD_NOT_WRITE = KJob::UserDefinedError + 23,
    ERR_COULD_NOT_BIND = KJob::UserDefinedError + 24,
    ERR_COULD_NOT_LISTEN = KJob::UserDefinedError + 25,
    ERR_COULD_NOT_ACCEPT = KJob::UserDefinedError + 26,
    ERR_COULD_NOT_LOGIN = KJob::UserDefinedError + 27,
    ERR_COULD_NOT_STAT = KJob::UserDefinedError + 28,
    ERR_COULD_NOT_CLOSEDIR = KJob::UserDefinedError + 29,
    ERR_COULD_NOT_MKDIR = KJob::UserDefinedError + 30,
    ERR_COULD_NOT_RMDIR = KJob::UserDefinedError + 31,
    ERR_COULD_NOT_SEEK = KJob::UserDefinedError + 32,
    ERR_CANNOT_RESUME = KJob::UserDefinedError + 33,
    ERR_CANNOT_RENAME = KJob::UserDefinedError + 34,
    ERR_CANNOT_CHMOD = KJob::UserDefinedError + 35,
    ERR_CANNOT_DELETE = KJob::UserDefinedError + 36,
    ERR_CANNOT_CHOWN = KJob::UserDefinedError + 37,
    // The text argument is the protocol that the dead slave supported.
    // This means for example: file, ftp, http, ...
    ERR_SLAVE_DIED = KJob::UserDefinedError + 38,
    ERR_OUT_OF_MEMORY = KJob::UserDefinedError + 39,
    ERR_UNKNOWN_PROXY_HOST = KJob::UserDefinedError + 40,
    ERR_COULD_NOT_AUTHENTICATE = KJob::UserDefinedError + 41,
    // Action got aborted from application side
    ERR_ABORTED = KJob::UserDefinedError + 42,
    ERR_INTERNAL_SERVER = KJob::UserDefinedError + 43,
    ERR_SERVER_TIMEOUT = KJob::UserDefinedError + 44,
    ERR_SERVICE_NOT_AVAILABLE = KJob::UserDefinedError + 45,
    ERR_UNKNOWN = KJob::UserDefinedError + 46,
    ERR_CANNOT_DELETE_ORIGINAL = KJob::UserDefinedError + 47,
    ERR_CANNOT_DELETE_PARTIAL = KJob::UserDefinedError + 48,
    ERR_CANNOT_RENAME_ORIGINAL = KJob::UserDefinedError + 49,
    ERR_CANNOT_RENAME_PARTIAL = KJob::UserDefinedError + 50,
    ERR_CANNOT_SYMLINK = KJob::UserDefinedError + 51,
    // Action succeeded but no content will follow.
    ERR_NO_CONTENT = KJob::UserDefinedError + 52,
    ERR_DISK_FULL = KJob::UserDefinedError + 53,
    // src==dest when moving/copying
    ERR_IDENTICAL_FILES = KJob::UserDefinedError + 54,
    ...
    // forked.
    ERR_SLAVE_DEFINED = KJob::UserDefinedError + 55,
    // Emitted by setModificationTime
    ERR_CANNOT_SETTIME = KJob::UserDefinedError + 56
  };
